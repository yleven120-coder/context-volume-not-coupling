# =============================================================================
# exp1_pilot_1p5B.py -- Pilot run disclosed in the paper (Sec. 2.4)
# Coupled (C) vs. Single (S), 10 opener-paired runs, recovery window = 5.
# Identical to exp2 except N_RUNS=10 and N_RECOVERY=5. Pilot data are excluded
# from all paper analyses and archived for transparency.
# Colab setup: run `pip install -q -U transformers accelerate scipy` first (T4 GPU).
